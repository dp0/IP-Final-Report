\begin{figure}
	\centering
		...
		\end{tikzpicture}
		\caption{Simulation lag for network sizes for varying simulation lengths (UAP)}
...
\begin{figure}
	\centering
		...
		\end{axis}
		\end{tikzpicture}
		\caption{Critical point of failure for simulation lengths (UAP)}
...
\begin{figure}
	\centering
		...
		point meta=explicit symbolic,
		scatter/classes={
			universal={mark=square*,cyan},
			selective={mark=o,draw=green},
			forward={mark=triangle*,red}
		},
		]
		table[meta=label] {
			x y label
