\begin{figure}[!h]
	\begin{center}
		\begin{tikzpicture}
		\umlactor[y=1]{Node}
		\begin{umlsystem}[fill=red!10]{Internodal Communications}
		...
		\end{tikzpicture}
	\end{center}
	\caption{Protocol's Internodal Communications Use Case Diagram\label{fig:protointernodalconusecase}}
\end{figure}
\begin{figure}[!h]
	\begin{center}
		...
		\end{tikzpicture}
	\end{center}
	\caption{Protocol Class Diagram}
\end{figure}
...
\begin{figure}[!hbt]
	\begin{center}
		...
		\end{tikzpicture}
	\end{center}
	\caption{Protocol Selective Polling Sequence Diagram}
\end{figure}
...
\begin{figure}[!hbt]
	\begin{center}
		...
		\end{tikzpicture}
	\end{center}
	\caption{Protocol Active Forwarding Sequence Diagram}
\end{figure}